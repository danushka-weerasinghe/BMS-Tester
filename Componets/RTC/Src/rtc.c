                 ...
                 uint8_t dow, uint8_t day, uint8_t month, uint8_t year)
{
    ...
    HAL_I2C_Mem_Write(&hi2c1, MCP7940N_I2C_ADDR, MCP7940N_RTCSEC, 1, data, 7, HAL_MAX_DELAY);
}
...
void RTC_SetTrim(int8_t trim_value) {
    ...
    HAL_I2C_Mem_Write(&hi2c1, MCP7940N_I2C_ADDR, MCP7940N_OSCTRIM, 1, &trim_reg, 1, HAL_MAX_DELAY);
}
