...
Switches/%.o Switches/%.su Switches/%.cyclo: ../Switches/%.c Switches/subdir.mk
...
clean: clean-Switches

clean-Switches:
	-$(RM) ./Switches/Switches.cyclo ./Switches/Switches.d ./Switches/Switches.o ./Switches/Switches.su

.PHONY: clean-Switches
