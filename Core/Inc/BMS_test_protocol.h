...
#include "flash_Itc.h"
#include "INA229.h"
#include "gpio_expander.h"  // For CellID type
 ...
 // External BMS IC variables from UserInterface.c
...
void Set_Output_Voltage(CellID id, float voltage);
void Set_Resistance(uint8_t tempCardId, uint8_t resistance);
void Set_LED_status(CellID id, uint8_t state);
...
void send_menu_via_rs485_and_display(void);
